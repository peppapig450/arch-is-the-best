...
(define Main-main(blodwen-lazy (lambda () (PreludeC-45IO-putStrLn (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-215) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-215 eta-0)))))) (lambda (u--a) (lambda (arg-609) (lambda (eta-0) arg-609))) (lambda (u--b) (lambda (u--a) (lambda (arg-610) (lambda (arg-612) (lambda (eta-0) (let ((act-17 (arg-610 eta-0))) (let ((act-16 (arg-612 eta-0))) (act-17 act-16))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-893) (lambda (arg-894) (lambda (eta-0) (let ((act-24 (arg-893 eta-0))) ((arg-894 act-24) eta-0))))))) (lambda (u--a) (lambda (arg-896) (lambda (eta-0) (let ((act-51 (arg-896 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-7021) arg-7021))) "Arch is the best!"))))
